...
renderChips("chips-picantes", salsasPicantes, "chip-spicy transition-colors");
renderChips("chips-dulces", salsasDulces, "chip-sweet transition-colors");
renderChips("chips-saladas", salsasSaladas, "chip-savory transition-colors");
